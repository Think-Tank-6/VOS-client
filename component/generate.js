              ...
              <View style={styles.genderBox}>
                <TouchableOpacity
                  style={[
                    ...
                    {
                      backgroundColor:
                        gender === "M" ? "rgba(61,159,136,0.5)" : "gray",
                    },
                  ]}
                  onPress={() => handleGenderChange("M")}
                >
                  <Text style={{ color: gender === "M" ? "white" : "#B1B1B1" }}>
                    남
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[
                    ...
                    {
                      backgroundColor:
                        gender === "F" ? "rgba(61,159,136,0.5)" : "gray",
                    },
                  ]}
                  onPress={() => handleGenderChange("F")}
                >
                  <Text style={{ color: gender === "F" ? "white" : "#B1B1B1" }}>
                    여
                  </Text>
                </TouchableOpacity>
              </View>
